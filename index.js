...
tg.router
	...
	.when(new CustomFilterCommand($ => {
		return !($.message.from.id == '17694064') && $.message.chat.username == 'savefolla' || $.message.chat.username == 'Sparkolo' || $.message.chat.username == 'ohalbero' || $.message.chat.username == 'joemerlino';
	}), new AdminController())
